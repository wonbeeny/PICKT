...
class PicktQuestionEmbedding(nn.Module):
    ...
    def forward(
        ...
        question_embeddings = question_embeds + type_embeds + difficulty_embeds + \
...
class PicktResponseEmbedding(nn.Module):
    ...
    def forward(
        ...
        response_embeddings = response_embeds + position_embeddings
...
class PicktMilktModel(nn.Module):
    """
    최종 PICKT 모델 구조
    """
    def __init__(self, config):
