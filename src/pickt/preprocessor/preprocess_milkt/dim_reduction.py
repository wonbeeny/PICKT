...
parser.add_argument(
    "--concept_embed_path",
    type = str,
    default = "/home/jovyan/work/PICKT/data/Online/concept_embeddings.pt",
...
parser.add_argument(
    "--save_path",
    type = str,
    default = "/home/jovyan/work/PICKT/data/Online/reduced_embeddings_pca.json",
...
def dim_red_pca(embed, n_components):
    ...
    reduced_pca[-2] = 0    # pad_id 위치는 전부 0으로 변환
    # reduced_pca[-1] = 0    # unk_id 위치는 0이 아님
...
def dim_red_umap(embed, n_components):
    ...
    reduced_umap[-2] = 0    # pad_id 위치는 전부 0으로 변환
    # reduced_umap[-1] = 0    # unk_id 위치는 0이 아님
...
if __name__ == "__main__":
    ...
    print(f"✅ 성공: reduced_embdding_pca.json 이 저장되었습니다.")
    print("Finish..")